...
const API = (() => {
  ...
  return {
    ...
    saveChecklistEntry: (exercise_id, entry_date, performed_reps, performed_distance_km) =>
      request('POST', '/exercises/checklist/entry', { exercise_id, entry_date, performed_reps, performed_distance_km }),
    ...
    saveGymChecklistEntry: (exercise_name, session_name, entry_date, completed, performed_reps) =>
      request('POST', '/gym-checklist/entry', { exercise_name, session_name, entry_date, completed, performed_reps }),
